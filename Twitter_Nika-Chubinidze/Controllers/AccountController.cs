...
namespace Twitter_Nika_Chubinidze.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterAndLoginViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new TwitterUser { UserName = model.Register.Email, Email = model.Register.Email, EmailConfirmed = true, Name = model.Register.FirstName, Surname = model.Register.LastName };
